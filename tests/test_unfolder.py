...
from cad.edge_classifier import Bounds, EdgeRecord
...
class TubeUnfolderTests(unittest.TestCase):
    def test_builds_preview_segments_from_counted_edges(self) -> None:
        ...
        self.assertEqual(preview.segments[0].start.x_mm, 300.0)
        self.assertEqual(preview.segments[0].start.y_mm, 20.0)
    ...
    def test_same_tube_end_segments_share_component_id(self) -> None:
        ...
        self.assertEqual(preview.segments[0].component_id, preview.segments[1].component_id)
        self.assertNotEqual(preview.segments[0].component_id, preview.segments[2].component_id)
